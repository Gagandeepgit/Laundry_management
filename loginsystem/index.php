...
<html lang="en">
    <head>
        ...
        <title>Home | Laundry Management System </title>
    ...
    <body>
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="index.php">Laundry Management System</a>
            <!-- Sidebar Toggle-->
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">   User Registration & Login and Laundry Management System With admin panel</h1>
