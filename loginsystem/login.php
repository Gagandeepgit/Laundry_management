...
<html lang="en">
    <head>
        ...
        <title>User Login | Laundry Management System</title>
        <link href="css/styles.css" rel="stylesheet" />
        <script src="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.3/js/all.min.js" crossorigin="anonymous"></script>
        <!-- <style>
            body{
                background-image: url("C:\Users\GAGAN\OneDrive\Pictures\washing-machine-with-cleanser-iron-ironing-board-clean-clothes-laundry-service-room_313242-126.webp");
...
<h2 align="center">Laundry Management System</h2>
<hr />
