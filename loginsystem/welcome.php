...
{?>                        
                        <div class="row">
                            <div class="col-xl-5 col-md-6" >
                                ...
                                <div class="card1 bg-primary text-white mb-4">
                                    <div class="card-body">Send a Laundry Request</div>
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white stretched-link" href="laundry_form.php">Click to Send</a>
                                        <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                    </div>
                                </div>
